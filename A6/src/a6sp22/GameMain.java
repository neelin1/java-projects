 ...
 * not the hardest assignment, but time consuming because it is new material with a lot of methods
 */
...
public class GameMain {
    ...
    private static void createAndShowGUI() {
        ...
        game.addPropertyChangeListener("GameScore", pl);
        ...
        sizeSlider.addChangeListener(cl1);
        ...
        ChangeListener cl2= e -> {
            game.setTargetTimeMillis(speedSlider.getValue());
        };

        speedSlider.addChangeListener(cl2);
    ...
    private static JComponent makeSliderPanel(JSlider slider, String title) {
        ...
        JLabel sliderLabel= new JLabel(title,
            SwingConstants.CENTER);
        sliderLabel.setFont(sliderLabel.getFont().deriveFont(16.0f));
    ...
    private static void saveScore(JFrame frame, int score) {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try (PrintWriter out= new PrintWriter(new BufferedWriter(new FileWriter(file, true)))) {
                ...
                pane.showMessageDialog(frame, e.getMessage(), e.getClass().getName(),
