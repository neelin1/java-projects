 ...
 *
 * 1. Name(s): Aldin Aksay, Zane Neelin
 * 2. Netid(s): afa48, zmn5
 * 3. Took CS1110 (yes or no): no
 * 3. Took CS1110 (yes or no): no
 * 4: Took CS1112 (yes or no): no
 * 4: Took CS1112 (yes or no): no
 * 5. I know Java (yes or no): AP level
 * 5. I know Java (yes or no): yes
 * 6. Tell us what you thought of this assignment:
 * Fairly easy methods to write.
 *
 */
...
public class A2 {
    ...
    public static double timeSpent= 0.75;
