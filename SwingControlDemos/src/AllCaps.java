...
/** In the window that appears, you can type any keystroke,
  it is printed --capitalized if it is a letter. */
public class AllCaps extends KeyAdapter {
    
    JFrame capsFrame= new JFrame("KeyAdaptor Example");
    JLabel capsLabel= new JLabel();
    
    /** Create a GUI with a window in which you type a keystroke,
     * which is printed, capitalized if it is a letter.  */
